              ...
              {SERVICES.map((service, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative flex h-full min-h-[260px] flex-col justify-between rounded-3xl border border-[#ECECEC] bg-white p-7 transition-all duration-300 hover:-translate-y-2 hover:border-[#7B3FFF]/20 hover:shadow-[0_20px_50px_rgba(123,63,255,0.12)]"
                  >
                    ...
                    <div className="mt-8 flex items-center">
                      <span className="inline-flex items-center gap-2 text-sm font-semibold text-[#7B3FFF] transition-all duration-300 group-hover:gap-3">
                        Learn More
                        <ArrowRight size={16} />
                      </span>
                    </div>
